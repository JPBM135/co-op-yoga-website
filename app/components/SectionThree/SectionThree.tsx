      ...
      <div className={styles.image_part}>
        <div className={styles.top_image}>
          <div className={styles.image_div1}>
            <Image src={yoga1} className={styles.image1} alt={"routine-yoga-1"}></Image>
            <div className={styles.box1}>
              <Image src={box1} alt={"box1"}></Image><span>High Quality Video</span>
            </div>
          </div>
        </div>
        <div className={styles.bottom_image}>
          <div className={styles.image_div2}>
            <Image src={yoga2} alt={"routine-yoga-2"} className={styles.image2}></Image>
            <div className={styles.box2}>
              <Image src={box2} alt={"box2"}></Image><span>Professional Trainer</span>
            </div>
          </div>
        </div>
      </div>
